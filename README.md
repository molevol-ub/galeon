...
- **FastTree** - Alternatively, GALEON can use FastTree to infer the phylogeny among gene family copies. Much faster but less accurate. http://www.microbesonline.org/fasttree/
